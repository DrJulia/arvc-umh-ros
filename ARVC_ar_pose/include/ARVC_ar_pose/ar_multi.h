...
namespace ar_pose
{
  ...
  private:
    ...
    // **** for visualisation in rviz
      ...
      visualization_msgs::Marker rvizMarker2_;
      visualization_msgs::Marker rvizMarker3_;
    ...
    double getDynamicThreshold(const ARUint8* dataPtr, const ARMarkerInfo* marker_info, const int marker_num);
