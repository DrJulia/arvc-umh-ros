...
public:
	...
	static treeNode* createTreePartitioning(const gridMapInterface& omap, const geometry_msgs::Point& rcell, int dilationradius, int actionradius, int min_cluster_size);
