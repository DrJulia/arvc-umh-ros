...
* Class binMap
*
* Implements the data returned by a range sensor as in example a sonar ring
*
*/
/// TODO: include appropiate constructors and initializers with non-default parameters
