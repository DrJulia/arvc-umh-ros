...
reactive::reactive(const ConfigFile& config):
	...
	resolution			(config.read<float>("RESOLUTION")),
	...
	goToImprecisePosesEnabled	(false),
	...
	goToImprecisePosesWeight	(config.read<float>("WEIGHTGOIMP")),
	goToGoalWeight			(config.read<float>("WEIGHTGOGOAL")),
	avoidObstaclesWidth		(config.read<float>("SIGMAAVOBS")/resolution),
	goToFrontierWidth		(config.read<float>("SIGMAGOFRO")/resolution),
	goToUnexploredZonesWidth	(config.read<float>("SIGMAGOUZ")/resolution),
	avoidOtherRobotsWidth		(config.read<float>("SIGMAAVROB")/resolution),
	goToPrecisePosesWidth		(config.read<float>("SIGMAGOPRE")/resolution),
	goToImprecisePosesWidth		(config.read<float>("SIGMAGOIMP")/resolution),
	goToGoalWidth			(config.read<float>("SIGMAGOGOAL")/resolution),
