...
protected:
	...
	bool goToImprecisePosesEnabled;
...
public:
	...
	void disableGoToImprecisePoses();
	...
	void setWeightGoToImprecisePoses(float weight);
	...
	void setWidthGoToImprecisePoses(float width);
...
inline void reactive::enableGoToImprecisePoses()					{goToImprecisePosesEnabled=true;}
...
inline void reactive::disableGoToImprecisePoses()					{goToImprecisePosesEnabled=false;}
...
inline void reactive::setWeightGoToImprecisePoses(float weight)				{goToImprecisePosesWeight = weight;};
...
inline void reactive::setWidthGoToImprecisePoses(float width)				{goToImprecisePosesWidth = width;};
inline void reactive::setWidthGoToGoal(float width)					{goToGoalWidth = width;};

inline void reactive::setSlam(slamInterface& slamProc)					{mySlam = &slamProc;}
