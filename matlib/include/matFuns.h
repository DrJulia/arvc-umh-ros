...
public:
	...
	matrix(const tf::Pose& p);
	matrix(const geometry_msgs::Pose& p);
	matrix(int rows, int cols, const double* p);
	matrix(int rows, int cols, const float* p);
	...
	matrix& operator= (const tf::Pose&);
	matrix& operator= (const geometry_msgs::Pose&);
	matrix& operator+= (const matrix&);
	matrix& operator-= (const matrix&);
...
public:
	...
	Ematrix(const tf::Pose& p);
	Ematrix(const geometry_msgs::Pose& p);
	Ematrix(int rows, int cols, const double* p);
	Ematrix(int rows, int cols, const float* p);
	...
	Ematrix subMat(int rini, int rend, int cini, int cend) const;
	...
	Ematrix& operator= (const pose4&);
	Ematrix& operator= (const tf::Pose&);
	Ematrix& operator= (const geometry_msgs::Pose&);
...
inline int Ematrix::getRows() const					{return rows;};
inline int Ematrix::getCols() const					{return cols;};
...
float mahalanobis(const Ematrix& pos, const Ematrix& sigma);
float normal(const Ematrix& pos, const Ematrix& sigma);
